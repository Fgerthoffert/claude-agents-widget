...
| 2   | Detection core      | Hook CLI + installer, session state files, FS watcher, process scanner, reconciled session store with state machine | in-progress | -        | 1       | [plan](../plans/phase-2-detection-core.plan.md)       |
