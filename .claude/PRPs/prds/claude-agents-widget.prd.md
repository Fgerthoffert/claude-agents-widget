...
| 3   | UI surfaces         | Menu bar tray + dropdown, always-on-top floating panel, needs-input emphasis, launch at login                       | in-progress | with 4   | 2       | [plan](../plans/phase-3-ui-surfaces.plan.md)          |
| 4   | Focus engine        | Process-tree app identification, per-app focus adapters (Terminal.app, iTerm2, VS Code)                             | in-progress | with 3   | 2       | [plan](../plans/phase-4-focus-engine.plan.md)         |
