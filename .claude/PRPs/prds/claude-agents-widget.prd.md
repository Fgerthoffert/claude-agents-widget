...
| --- | ------------------- | ------------------------------------------------------------------------------------------------------------------- | ----------- | -------- | ------- | ----------------------------------------------------- |
| 1   | Scaffold & harness  | Tauri 2 + TS project, lint/format/typecheck, Vitest, CLAUDE.md, ADR seed, PR test workflow                          | in-progress | -        | -       | [plan](../plans/phase-1-scaffold-and-harness.plan.md) |
